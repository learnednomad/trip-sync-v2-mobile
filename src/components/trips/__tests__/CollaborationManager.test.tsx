...
import type { TripParticipant } from '@/api/trips/types';
...
describe('CollaborationManager Component', () => {
  ...
  describe('Modal Display', () => {
    it('should render when visible is true', () => {
      ...
      expect(
        screen.getByText('Manage trip participants and permissions')
      ).toBeTruthy();
    });
  ...
  describe('Role Management', () => {
    ...
    it('should update role when new role is selected', () => {
      ...
      expect(mockProps.onUpdateRole).toHaveBeenCalledWith(
        'participant-2',
        'VIEWER'
      );
    });
    ...
    it('should show permission details for each role', async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText('Can edit trip details and invite others')
        ).toBeTruthy(); // COLLABORATOR permissions
  ...
  describe('Participant Management', () => {
    it('should allow owner to remove participants', () => {
      ...
      expect(
        screen.getByText(
          'Are you sure you want to remove Active Collaborator from this trip?'
        )
      ).toBeTruthy();
    });
    ...
    it('should confirm participant removal', () => {
      ...
      expect(mockProps.onRemoveParticipant).toHaveBeenCalledWith(
        'participant-2'
      );
    });
    ...
    it('should not show remove button for owner', () => {
      ...
      const ownerRemoveButton = screen.queryByTestId(
        'remove-button-participant-1'
      );
  ...
  describe('Permission Display', () => {
    ...
    it('should show detailed permissions in expanded view', () => {
      ...
      const expandButton = screen.getByTestId(
        'expand-permissions-participant-2'
      );
  ...
  describe('Error Handling', () => {
    ...
    it('should handle role update errors', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText('Failed to update role. Please check permissions.')
        ).toBeTruthy();
      });
    });
    ...
    it('should handle participant removal errors', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText('Failed to remove participant. Please try again.')
        ).toBeTruthy();
      });
    });
  });

...
describe('QuickPlanModal Component', () => {
  ...
  describe('Modal Display', () => {
    it('should render when visible is true', () => {
      ...
      expect(screen.getByText('Create your perfect trip in 4 simple steps')).toBeTruthy();
    });
  ...
  describe('Step 1: Destination Selection', () => {
    it('should show destination input as first step', () => {
      ...
      expect(screen.getByText('Step 1 of 4: Where do you want to go?')).toBeTruthy();
  ...
  describe('Step 2: Trip Type Selection', () => {
    beforeEach(async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('Step 2 of 4: What type of trip?')).toBeTruthy();
      });
    });
    ...
    it('should select trip type and show description', () => {
      ...
      expect(screen.getByText('Relaxation and entertainment focused travel')).toBeTruthy();
    });
  ...
  describe('Step 3: Dates and Duration', () => {
    beforeEach(async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('Step 3 of 4: When and how long?')).toBeTruthy();
      });
    });
    ...
    it('should suggest optimal duration for trip type', () => {
      expect(screen.getByText('Recommended: 5-7 days for Leisure trips')).toBeTruthy();
    });
  ...
  describe('Step 4: Budget and Preferences', () => {
    beforeEach(async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('Step 4 of 4: Budget and preferences')).toBeTruthy();
      });
    });
    ...
    it('should provide budget suggestions based on destination and type', () => {
      expect(screen.getByText('Recommended budget for Rome: $1,500 - $2,500')).toBeTruthy();
    });
  ...
  describe('Smart Suggestions', () => {
    ...
    it('should adjust budget suggestions by destination', async () => {
      ...
      for (const dest of destinations) {
        ...
        await waitFor(() => {
          expect(screen.getByText(`Recommended budget for ${dest.city.split(',')[0]}: ${dest.budget}`)).toBeTruthy();
        });
      }
    });
  });
  ...
  describe('Accessibility', () => {
    ...
    it('should have proper form field accessibility', () => {
      ...
      const destinationInput = screen.getByPlaceholderText('Enter destination...');
      expect(destinationInput.props.accessibilityLabel).toBe('Destination input');
    });
  });
});
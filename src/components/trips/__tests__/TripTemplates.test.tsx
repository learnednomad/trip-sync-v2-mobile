...
import { type TripTemplate, TripTemplates } from '../TripTemplates';
...
const mockTemplates: TripTemplate[] = [
  {
    ...
    activities: ['Attend sessions', 'Network', 'Site visits'],
    packingItems: ['Business attire', 'Laptop', 'Business cards'],
  ...
  },
  {
    ...
    activities: ['Romantic dinners', 'Spa treatments', 'Sunset walks'],
    packingItems: ['Evening wear', 'Comfortable shoes', 'Camera'],
    coverImage: 'https://example.com/romantic.jpg',
    popularity: 78,
    isCustom: false,
  },
  {
    ...
    activities: ['Theme parks', 'Museums', 'Family games'],
    packingItems: ['Comfortable clothes', 'First aid kit', 'Entertainment'],
...
describe('TripTemplates Component', () => {
  ...
  describe('Modal Display', () => {
    it('should render when visible is true', () => {
      ...
      expect(
        screen.getByText('Choose from popular trip templates')
      ).toBeTruthy();
    });
  ...
  describe('Template Selection', () => {
    ...
    it('should display template details in customization panel', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(
            'Professional conference with networking opportunities'
          )
        ).toBeTruthy();
  ...
  describe('Accessibility', () => {
    it('should have proper accessibility labels', () => {
      ...
      const businessTemplate = screen.getByLabelText(
